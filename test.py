...
# Путь к фотографиям
path = 'C:/Users/Mchomak/PythonScripts/FaceID/data/images/Mikhail_Kobozev'

# Для детектирования лиц используем каскады Хаара
cascadePath = "C:/Users/Mchomak/PythonScripts/FaceID/models/haarcascade_frontalface_default.xml"
faceCascade = cv2.CascadeClassifier(cascadePath)

# Для распознавания используем локальные бинарные шаблоны
recognizer = cv2.face.EigenFaceRecognizer(1,8,8,8,123)
...
def get_images(path):
    ...
    for image_path in image_paths:
        ...
        gray = Image.open(os.path.join(path,image_path)).convert('L')
